...
const ChangeInfoScreen = ({route}) => {
    ...
    const [items, setItems] = useState([
        {label: 'Nam', value: 'Nam', icon: () => <Ionicons name="male" size={24} color="black" />},
        {label: 'Nữ', value: 'Nữ', icon: () => <Ionicons name="female" size={24} color="black" />},
        {label: 'Khác', value: 'Khác', icon: () => <Ionicons name="male-female" size={24} color="black" />}
    ])
            ...
            <ScrollView>
                <View>
                    ...
                    <View
                        className="mx-5"
                        style={{
                            marginTop: type === "GioiTinh" ? wp(30) : wp(20),
                        }}
                    >
                        <TouchableOpacity
